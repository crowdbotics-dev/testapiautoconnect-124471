...
## Project Structure
    ...
    ├── testapiautoconnect_124471  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnect_124471`
...
2. Clone this repo and `cd testapiautoconnect_124471`
